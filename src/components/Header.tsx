...
export default function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 mx-4 mt-4">
      <div className={`liquid-glass backdrop-blur-lg border border-white/20 shadow-lg shadow-blue-500/5 transition-all duration-500 ease-in-out ${
          ...
          <div className="flex justify-between items-center h-16">
            ...
            <div className="md:hidden flex items-center space-x-3">
              <button
                ...
                className="relative p-2.5 rounded-lg text-gray-700 hover:text-blue-600 transition-all duration-300 group overflow-hidden hover:bg-blue-500/5 active:bg-blue-500/10 active:scale-95"
