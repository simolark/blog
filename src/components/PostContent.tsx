        ...
        <div className="mt-16 p-8 bg-gradient-to-r from-blue-50 to-purple-50 rounded-3xl border border-gray-200/50">
          <div className="flex flex-col lg:flex-row items-center justify-between gap-6">
            <div className="text-center lg:text-left">
              <h3 className="text-lg font-semibold text-gray-900 mb-2">Like this article?</h3>
              <p className="text-gray-600">Feel free to share your thoughts or explore more related content.</p>
            </div>
